...
_ProfilesAdditionalproperties = Union[
    dict[str, "_ProfilesAdditionalpropertiesAdditionalproperties"], "_ProfilesAdditionalpropertiesTyped"
]
"""
...
_ProfilesAdditionalpropertiesAdditionalproperties = TypedDict(
    "_ProfilesAdditionalpropertiesAdditionalproperties",
    {
        # Enable the module
        "enabled": bool,
        # Application.

...
class Dispatcher(module.Module[None, _EventData, None, None]):
    ...
    def documentation_url(self) -> str:
        ...
        return "https://github.com/camptocamp/github-app-geo-project/blob/master/github_app_geo_project/module/internal/README.md"
...
async def process_event(
    ...
    for name in context.module_event_data.modules:
        ...
        for action in current_module.get_actions(
            ...
            job.github_event_name = context.github_event_name
            job.github_event_data = context.github_event_data
            job.module = name
            job.module_event_name = action.title or context.module_event_name
            job.module_event_data = current_module.event_data_to_json(action.data)

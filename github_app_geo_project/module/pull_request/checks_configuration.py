...
PullRequestChecksCommitsMessagesConfiguration = TypedDict('PullRequestChecksCommitsMessagesConfiguration', {
...
PullRequestChecksCommitsSpellingConfiguration = TypedDict('PullRequestChecksCommitsSpellingConfiguration', {
...
PullRequestChecksConfiguration = TypedDict('PullRequestChecksConfiguration', {
    # | Codespell.
    # |
    # | The codespell check configuration
    'codespell': "Codespell",
    ...
    'commits-messages': "PullRequestChecksCommitsMessagesConfiguration" | bool],
    # | pull request checks commits spelling.
    # |
    # | Aggregation type: oneOf
    # | Subtype: "PullRequestChecksCommitsSpellingConfiguration"
    'commits-spell': "PullRequestChecksCommitsSpellingConfiguration" | bool],
    # | pull request checks pull request spelling.
    # |
    # | Aggregation type: oneOf
    # | Subtype: "PullRequestChecksPullRequestSpellingConfiguration"
    'pull-request-spell': "PullRequestChecksPullRequestSpellingConfiguration" | bool],
}, total=False)
...
PullRequestChecksPullRequestSpellingConfiguration = TypedDict('PullRequestChecksPullRequestSpellingConfiguration', {

...
async def _get_dependencies(
    ...
    if os.environ.get("TEST") != "TRUE":
        ...
        await module_utils.run_timeout(
            ["ls", "-l", str(out_dir)],
            None,
            settings.versions.timeouts.renovate,
            f"Files generated by Renovate graph (expected: github-{github_project.owner}-{github_project.repository}.json)",
            "Error while getting files generated by Renovate graph",
            "Timeout while getting files generated by Renovate graph",
            cwd,
        )

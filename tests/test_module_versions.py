...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"type": "Best effort"}, {"type": "To be defined"}, True),
        ({"type": "To be defined"}, {"type": "Best effort"}, False),
        ({"type": "Unsupported"}, {"type": "Best effort"}, True),
        ({"type": "Best effort"}, {"type": "Unsupported"}, False),
        ({"type": "To be defined"}, {"type": "Date", "until": "2040-01-01"}, True),
        ({"type": "Unsupported"}, {"type": "Date", "until": "2040-01-01"}, True),
        ({"type": "Best effort"}, {"type": "Date", "until": "2040-01-01"}, True),
        ({"type": "Date", "until": "2040-01-01"}, {"type": "To be defined"}, False),
        ({"type": "Date", "until": "2040-01-01"}, {"type": "Unsupported"}, False),
        ({"type": "Date", "until": "2040-01-01"}, {"type": "Best effort"}, False),
        ({"type": "Date", "until": "2040-01-01"}, {"type": "Date", "until": "2040-01-01"}, True),
        ({"type": "Date", "until": "2045-01-01"}, {"type": "Date", "until": "2046-01-01"}, True),
        ({"type": "Date", "until": "2045-01-01"}, {"type": "Date", "until": "2044-01-01"}, False),
        ({"type": "Date", "until": "2046-01-01"}, {"type": "Date", "until": "2045-01-01"}, False),
        ({"type": "Date", "until": "2044-01-01"}, {"type": "Date", "until": "2045-01-01"}, True),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Category comparison
        ({"type": "Unsupported"}, {"type": "Best effort"}, -1),
        ({"type": "Best effort"}, {"type": "Unsupported"}, 1),
        ({"type": "Best effort"}, {"type": "Date", "until": "2024-06-01"}, -1),
        ({"type": "Date", "until": "2024-06-01"}, {"type": "Best effort"}, 1),
        ({"type": "To be defined"}, {"type": "Date", "until": "2024-06-01"}, -1),
        ({"type": "Date", "until": "2024-06-01"}, {"type": "To be defined"}, 1),
        ({"type": "Unknown"}, {"type": "To be defined"}, -1),
        ({"type": "To be defined"}, {"type": "Unknown"}, 1),
        # Date comparison
        ({"type": "Date", "until": "2024-06-01"}, {"type": "Date", "until": "2024-06-02"}, -1),
        ({"type": "Date", "until": "2024-06-02"}, {"type": "Date", "until": "2024-06-01"}, 1),
        ({"type": "Date", "until": "2024-06-01"}, {"type": "Date", "until": "2024-06-01"}, 0),
        # Same category
        ({"type": "Unsupported"}, {"type": "Unsupported"}, 0),
        ({"type": "Best effort"}, {"type": "Best effort"}, 0),
        ({"type": "To be defined"}, {"type": "To be defined"}, 0),
        ({"type": "Unknown"}, {"type": "Unknown"}, 0),
    ],
)
